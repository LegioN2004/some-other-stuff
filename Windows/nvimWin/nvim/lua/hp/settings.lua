...
vim.opt.scrolloff = 10 -- no of lines visible above and below the cursor while scrolling
-- vim.opt.shell = "pwsh"
...
-- Reduce command line messages since we can't see them properly anyway with cmdheight = 0
...
set completeopt=menuone,noinsert,noselect "as required by nvim-cmp
