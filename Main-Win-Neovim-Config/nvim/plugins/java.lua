    ...
    java = {
      ...
      configuration = {
        ...
        runtimes = {
          {
            name = "JavaSE-18",
            path = "/Users/sunny/Library/Java/JavaVirtualMachines/temurin-18.0.1/Contents/Home",
          },
          {
            name = "JavaSE-17",
            path = "/Users/sunny/Library/Java/JavaVirtualMachines/temurin-17.0.4/Contents/Home",
          }
        }
      },
      maven = {
