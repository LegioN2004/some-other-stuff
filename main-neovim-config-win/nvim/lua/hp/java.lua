...
local config = {
  ...
  cmd = {
    ...
    '/Users/hp/scoop/apps/oraclejdk-lts/current/bin/java.exe',
  ...
  settings = {
    java = {
      home = '/Users/hp/scoop/apps/oraclejdk-lts/current',
      eclipse = {
      ...
      configuration = {
        ...
        runtimes = {
          ...
          {
            name = "JavaSE-17",
            path = "/Users/hp/scoop/apps/oraclejdk-lts/current/bin/java.exe",
          }
        }
      },
      maven = {
