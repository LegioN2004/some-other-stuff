...
vim.cmd [[
	augroup run_file
		...
		"autocmd BufEnter *.cpp let @g=":w\<CR> :!g++ -std=c++23 -O3 %\<CR> | :vsp |terminal ./a.out\<CR>i"
		autocmd BufEnter *.cpp let @g=":w\<CR> :!g++ %:p:h -std=c++23 -o a.exe <CR> | :vsp |terminal .\a.exe\<CR>i"
